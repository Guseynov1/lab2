...
sau_reg = input("Введите наименование регулятора (пид или пи):")
...
# Нахожение второго максимума
max2 = max(y2)
zat3 = (max1 - max2) / max1
coleb3 = max1 / max2
per3 = ((max1 - h_infinity) / h_infinity) * 100
# Отобразим значения 3
print(colorama.Fore.BLUE)
print("3. Прямые оценки качества ПП")
print("a) Время регулирования:", treg3)
print("b) Перерегулирование:", per3)
print("c) Колебательность:", coleb3)
print("d) Степень затухания:", zat3)
print("e) Величина достижения первого максимума:", max1)
print("Время достижения первого максимума:", t1max3)
plt.plot(x, y, "red")
...
# 4. По распределению корней на комплексной плоскости Wzam
# Определение значения полюсов передаточной функции Wzam
a = mtb.pole(Wzam)
a = numpy.round(a, 3)
...
ctl.pzmap(Wzam, title="Карта полюсов и нулей Wzam")
plt.show()
# Отобразим значения 4
print(colorama.Fore.CYAN)
print("4. По распределению корней на комплексной плоскости Wzam")
print("a) Время регулирования:", treg4)
print("b) Перерегулирование:", per4)
print("c) Колебательность:", coleb4)
print("d) Степень затухания:", zat4)

# 5. ЛЧХ; Нахождение показателя колебательности:
...
y = phase[i]
fase = 180 - abs(y)
print("Запас устойчивости по фазе = ", fase)
k = 0
...
if k == 1:
    ...
    amp = abs(0 - mag[-1])
print("Запас устойчивости по амплитуде = ", amp)
print(colorama.Fore.RED)
print("Запас устойчивости по амплитуде равен бесконечности, т.к. фазовая характеристика не пересекает линию -180 град.")

# Отобразим значения 5
print(colorama.Fore.YELLOW)
print("5. ЛЧХ")
print("a) Время регулирования:", treg5)
print("b) Показатель колебательности:", koleb5)
...
print("Интегральный метод Q")
print("Значение интеграла", Q)
print()
print("Показатели качества:")
print("Время регулирования: 11 = ", treg3)
print("Перерегулирование: 28 = ", per3)
print("Показатель колебательности: 1.23 = ", koleb5)
